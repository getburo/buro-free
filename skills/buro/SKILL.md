...
description: >-
  ...
  reviewing the actual software (dev), open-source intelligence — what is true before you build,
  sourced and verified (osint), does-it-break testing (tester),
  form-of-the-best-of-its-form critique (critic), whole-work vision
...
**The twelve departments, and this tier's one seat from each — peers, not a hierarchy:**
...
- **A small whole project** within this tier's reach (a doc set, a single screen or small flow, a
  game system's design, one physical object's form, a small piece of software, an ad set) — start
  with `buro:process` (it
...
| the FORM of a physical product — ergonomics, affordances, Rams' ten (specs, doesn't manufacture) | `buro:industrial-designer` |
| the individual ad units per format — hook, headline, honest demo, CTA | `buro:ad-creative` |
| general software — write/refactor code, architecture, code review, code quality | `buro:dev` |
...
|---|---|---|
| a **manufacturable physical object** (ergonomics, materials, DFM) | a visual/digital asset brief | `buro:industrial-designer` |
| **writing or reviewing the code itself** — architecture, implementation, PR review, code quality | black-box QA of the finished product | `buro:dev` |
| **breaking a built product from outside** — edge cases, adversarial input, reproducible bugs | reviewing the source that produced it | `buro:tester` |
